...
# 📁 경로 설정
screenshot_path = "data/game_screenshot.png"
center_path = "data/center_grid.npy"
ocr_csv_path = "data/ocr_result_corrected_10x17.csv"
output_dir = "data/ocr_data"
debug_dir = "data/debug_samples"  # 디버깅용 저장 경로
